...
export const TitleCardActivity = styled.Text`
    font-size: ${RFValue(25, deviceDimensions.height)}px;
    color: #fff;
    font-weight: 500;
`;

export const SituationCardActivity = styled.Text`
    font-size: ${RFValue(20, deviceDimensions.height)}px;
    color: #fff;
    font-weight: bold;
`;

export const BotaoCardActivity = styled.TouchableOpacity`
    justify-content: flex-end;
`;

export const BotoesCardActivity = styled.View`
    display: flex;
    justify-content: space-between;
...
export const TitleNotesActivity = styled.Text`
