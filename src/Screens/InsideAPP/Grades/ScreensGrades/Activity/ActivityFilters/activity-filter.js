...
// import { getAllActivity, getActivityByID } from "../../../../../Services/Requisicoes/Activity/activity-service";
...
//         const result = await getActivityByID(tokenJWT, idDiscipline);
//         console.log(result);
//         if (result) {
